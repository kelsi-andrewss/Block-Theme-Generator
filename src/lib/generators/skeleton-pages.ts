...
const check = `<svg style="width:1.25rem;height:1.25rem;color:#22c55e;flex-shrink:0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>`;
...
const saasSignup: SkeletonPage = {
  title: "Sign Up",
  slug: "signup",
  content: `<!-- wp:group {"layout":{"type":"constrained","contentSize":"480px"},"style":{"spacing":{"padding":{"top":"6rem","bottom":"6rem"}}}} -->
<div class="wp-block-group" style="padding-top:6rem;padding-bottom:6rem">

<!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"2.25rem","fontWeight":"800"},"spacing":{"margin":{"bottom":"1rem"}}}} -->
<h1 class="wp-block-heading has-text-align-center" style="font-size:2.25rem;font-weight:800;margin-bottom:1rem">Create your account</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"2.5rem"}}}} -->
<p class="has-text-align-center" style="color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent);margin-bottom:2.5rem">Start your 14-day free trial. No credit card required.</p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"2.5rem","right":"2.5rem","bottom":"2.5rem","left":"2.5rem"}}}} -->
<div class="wp-block-group" style="padding:2.5rem;border-radius:1rem;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 15%, transparent);background-color:var(--wp--preset--color--base)">

<!-- wp:group {"style":{"spacing":{"margin":{"bottom":"1.25rem"}}}} -->
<div class="wp-block-group" style="margin-bottom:1.25rem">
<!-- wp:paragraph {"style":{"typography":{"fontSize":"0.875rem","fontWeight":"600"},"spacing":{"margin":{"bottom":"0.5rem"}}}} -->
<p style="font-size:0.875rem;font-weight:600;margin-bottom:0.5rem">Full Name</p>
<!-- /wp:paragraph -->
<!-- wp:group -->
...
<div class="wp-block-group" style="margin-bottom:1.25rem">
<!-- wp:paragraph {"style":{"typography":{"fontSize":"0.875rem","fontWeight":"600"},"spacing":{"margin":{"bottom":"0.5rem"}}}} -->
<p style="font-size:0.875rem;font-weight:600;margin-bottom:0.5rem">Work Email</p>
<!-- /wp:paragraph -->
<!-- wp:group -->
<div class="wp-block-group" style="height:2.75rem;border-radius:0.5rem;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 20%, transparent);background-color:color-mix(in srgb, var(--wp--preset--color--contrast) 3%, transparent)"></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"typography":{"fontSize":"0.875rem","fontWeight":"600"},"spacing":{"margin":{"bottom":"0.5rem"}}}} -->
<p style="font-size:0.875rem;font-weight:600;margin-bottom:0.5rem">Password</p>
<!-- /wp:paragraph -->
<!-- wp:group -->
<div class="wp-block-group" style="height:2.75rem;border-radius:0.5rem;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 20%, transparent);background-color:color-mix(in srgb, var(--wp--preset--color--contrast) 3%, transparent)"></div>
<!-- /wp:group -->
...
<!-- wp:button {"width":100} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" style="border-radius:0.5rem;padding:0.75rem;background-color:var(--wp--preset--color--primary);color:var(--wp--preset--color--base);font-weight:700;text-align:center">Create Account</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->

<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"1.5rem"}}}} -->
<p class="has-text-align-center" style="font-size:0.8125rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 50%, transparent);margin-top:1.5rem">By signing up you agree to our Terms of Service and Privacy Policy.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"1.5rem"}}}} -->
<p class="has-text-align-center" style="font-size:0.875rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent);margin-top:1.5rem">Already have an account? <span style="color:var(--wp--preset--color--primary);font-weight:600">Sign in</span></p>
<!-- /wp:paragraph -->
...
const saasPricing: SkeletonPage = {
  title: "Pricing",
  slug: "pricing",
  content: `<!-- wp:group {"layout":{"type":"constrained"},"style":{"spacing":{"padding":{"top":"6rem","bottom":"8rem"}}}} -->
<div class="wp-block-group" style="padding-top:6rem;padding-bottom:8rem">
...
<!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"clamp(2.25rem, 4vw, 3rem)","fontWeight":"800"}}} -->
<h1 class="wp-block-heading has-text-align-center" style="font-size:clamp(2.25rem, 4vw, 3rem);font-weight:800;margin-bottom:1.5rem">Simple, transparent pricing</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center" style="font-size:1.125rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent);line-height:1.625">No hidden fees, no surprises. Start free and scale as your team grows.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->

<!-- wp:group {"className":"saas-pricing-grid"} -->
<div class="wp-block-group saas-pricing-grid" style="display:grid;grid-template-columns:repeat(auto-fit, minmax(280px, 1fr));gap:2rem;max-width:1024px;margin:0 auto;align-items:center">

<!-- wp:group -->
<div class="wp-block-group" style="padding:2rem;border-radius:1.5rem;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 15%, transparent);background-color:var(--wp--preset--color--base);display:flex;flex-direction:column">
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.25rem","fontWeight":"700"}}} -->
<h3 class="wp-block-heading" style="font-size:1.25rem;font-weight:700;margin-bottom:0.5rem">Starter</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p style="color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent);font-size:0.875rem;margin-bottom:1.5rem">For individuals and small projects.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p style="margin-bottom:1.5rem"><span style="font-size:2.25rem;font-weight:800">Free</span></p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
<div class="wp-block-buttons">
<!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="display:block;width:100%;padding:0.75rem;border-radius:0.5rem;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 20%, transparent);background-color:var(--wp--preset--color--base);color:var(--wp--preset--color--contrast);font-weight:500;text-align:center;margin-bottom:2rem">Get Started</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
<!-- wp:list -->
<ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:0.75rem;font-size:0.875rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">
<li style="display:flex;align-items:center;gap:0.75rem">${check} Up to 3 projects</li>
<li style="display:flex;align-items:center;gap:0.75rem">${check} Basic analytics</li>
<li style="display:flex;align-items:center;gap:0.75rem">${check} Community support</li>
</ul>
<!-- /wp:list -->
</div>
<!-- /wp:group -->
...
<!-- wp:group -->
<div class="wp-block-group" style="padding:2rem;border-radius:1.5rem;border:2px solid var(--wp--preset--color--primary);background-color:var(--wp--preset--color--base);display:flex;flex-direction:column;position:relative;box-shadow:0 20px 25px -5px color-mix(in srgb, var(--wp--preset--color--primary) 10%, transparent)">
<!-- wp:group -->
...
<!-- /wp:group -->
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.25rem","fontWeight":"700"}}} -->
<h3 class="wp-block-heading" style="font-size:1.25rem;font-weight:700;color:var(--wp--preset--color--primary);margin-bottom:0.5rem">Pro</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p style="color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent);font-size:0.875rem;margin-bottom:1.5rem">For growing teams who need more power.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p style="margin-bottom:1.5rem"><span style="font-size:2.25rem;font-weight:800">$29</span><span style="color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent)">/mo</span></p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
<div class="wp-block-buttons">
<!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="display:block;width:100%;padding:0.75rem;border-radius:0.5rem;background-color:var(--wp--preset--color--primary);color:var(--wp--preset--color--base);font-weight:700;text-align:center;margin-bottom:2rem">Start Free Trial</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
<!-- wp:list -->
<ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:0.75rem;font-size:0.875rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">
<li style="display:flex;align-items:center;gap:0.75rem">${check} Unlimited projects</li>
<li style="display:flex;align-items:center;gap:0.75rem">${check} Advanced analytics</li>
<li style="display:flex;align-items:center;gap:0.75rem">${check} Priority support</li>
<li style="display:flex;align-items:center;gap:0.75rem">${check} Custom integrations</li>
</ul>
<!-- /wp:list -->
</div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="padding:2rem;border-radius:1.5rem;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 15%, transparent);background-color:var(--wp--preset--color--base);display:flex;flex-direction:column">
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.25rem","fontWeight":"700"}}} -->
<h3 class="wp-block-heading" style="font-size:1.25rem;font-weight:700;margin-bottom:0.5rem">Enterprise</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p style="color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent);font-size:0.875rem;margin-bottom:1.5rem">For organizations that need full control.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p style="margin-bottom:1.5rem"><span style="font-size:2.25rem;font-weight:800">$99</span><span style="color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent)">/mo</span></p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
<div class="wp-block-buttons">
<!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="display:block;width:100%;padding:0.75rem;border-radius:0.5rem;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 20%, transparent);background-color:var(--wp--preset--color--base);color:var(--wp--preset--color--contrast);font-weight:500;text-align:center;margin-bottom:2rem">Contact Sales</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
<!-- wp:list -->
<ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:0.75rem;font-size:0.875rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">
<li style="display:flex;align-items:center;gap:0.75rem">${check} Everything in Pro</li>
<li style="display:flex;align-items:center;gap:0.75rem">${check} Dedicated account manager</li>
<li style="display:flex;align-items:center;gap:0.75rem">${check} SLA guarantees</li>
<li style="display:flex;align-items:center;gap:0.75rem">${check} SSO &amp; audit logs</li>
</ul>
<!-- /wp:list -->
</div>
<!-- /wp:group -->
...
const saasDocs: SkeletonPage = {
  title: "Documentation",
  slug: "documentation",
  content: `<!-- wp:group {"layout":{"type":"constrained"},"style":{"spacing":{"padding":{"top":"4rem","bottom":"6rem"}}}} -->
<div class="wp-block-group" style="padding-top:4rem;padding-bottom:6rem">

<!-- wp:columns {"style":{"spacing":{"blockGap":"4rem"}}} -->
<div class="wp-block-columns" style="gap:4rem">

<!-- wp:column {"width":"240px"} -->
<div class="wp-block-column" style="flex-basis:240px">
<!-- wp:heading {"level":4,"style":{"typography":{"fontSize":"0.75rem","fontWeight":"700"},"spacing":{"margin":{"bottom":"1rem"}}}} -->
<h4 class="wp-block-heading" style="font-size:0.75rem;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:color-mix(in srgb, var(--wp--preset--color--contrast) 50%, transparent);margin-bottom:1rem">Getting Started</h4>
<!-- /wp:heading -->
<!-- wp:list -->
<ul style="list-style:none;padding:0;margin:0 0 2rem 0;display:flex;flex-direction:column;gap:0.5rem;font-size:0.875rem">
<li style="padding:0.375rem 0.75rem;border-radius:0.375rem;background-color:color-mix(in srgb, var(--wp--preset--color--primary) 10%, transparent);color:var(--wp--preset--color--primary);font-weight:600">Introduction</li>
<li style="padding:0.375rem 0.75rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">Quick Start</li>
<li style="padding:0.375rem 0.75rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">Installation</li>
<li style="padding:0.375rem 0.75rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">Configuration</li>
</ul>
<!-- /wp:list -->
<!-- wp:heading {"level":4,"style":{"typography":{"fontSize":"0.75rem","fontWeight":"700"},"spacing":{"margin":{"bottom":"1rem"}}}} -->
<h4 class="wp-block-heading" style="font-size:0.75rem;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:color-mix(in srgb, var(--wp--preset--color--contrast) 50%, transparent);margin-bottom:1rem">Core Concepts</h4>
<!-- /wp:heading -->
<!-- wp:list -->
<ul style="list-style:none;padding:0;margin:0 0 2rem 0;display:flex;flex-direction:column;gap:0.5rem;font-size:0.875rem">
<li style="padding:0.375rem 0.75rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">Workflows</li>
<li style="padding:0.375rem 0.75rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">Pipelines</li>
<li style="padding:0.375rem 0.75rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">Environments</li>
</ul>
<!-- /wp:list -->
<!-- wp:heading {"level":4,"style":{"typography":{"fontSize":"0.75rem","fontWeight":"700"},"spacing":{"margin":{"bottom":"1rem"}}}} -->
<h4 class="wp-block-heading" style="font-size:0.75rem;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:color-mix(in srgb, var(--wp--preset--color--contrast) 50%, transparent);margin-bottom:1rem">API Reference</h4>
<!-- /wp:heading -->
<!-- wp:list -->
<ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:0.5rem;font-size:0.875rem">
<li style="padding:0.375rem 0.75rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">Authentication</li>
<li style="padding:0.375rem 0.75rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">REST Endpoints</li>
<li style="padding:0.375rem 0.75rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 70%, transparent)">Webhooks</li>
</ul>
<!-- /wp:list -->
</div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"0.5rem"}}}} -->
<p style="font-size:0.8125rem;font-weight:600;color:var(--wp--preset--color--primary);text-transform:uppercase;letter-spacing:0.05em;margin-bottom:0.5rem">Getting Started</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"2.25rem","fontWeight":"800"},"spacing":{"margin":{"bottom":"1.5rem"}}}} -->
<h1 class="wp-block-heading" style="font-size:2.25rem;font-weight:800;margin-bottom:1.5rem">Introduction</h1>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p style="font-size:1.125rem;line-height:1.75;color:color-mix(in srgb, var(--wp--preset--color--contrast) 80%, transparent);margin-bottom:2rem">Welcome to the platform documentation. This guide walks you through everything you need to get up and running, from initial setup to advanced configuration.</p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"1.25rem","right":"1.5rem","bottom":"1.25rem","left":"1.5rem"},"margin":{"bottom":"2rem"}}}} -->
<div class="wp-block-group" style="padding:1.25rem 1.5rem;border-radius:0.75rem;border-left:4px solid var(--wp--preset--color--primary);background-color:color-mix(in srgb, var(--wp--preset--color--primary) 5%, transparent);margin-bottom:2rem">
<!-- wp:paragraph -->
<p style="font-size:0.875rem;line-height:1.625;margin:0"><strong>Tip:</strong> If you are migrating from another platform, check our migration guide for step-by-step instructions.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->

<!-- wp:heading {"level":2,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"700"},"spacing":{"margin":{"bottom":"1rem"}}}} -->
<h2 class="wp-block-heading" style="font-size:1.5rem;font-weight:700;margin-bottom:1rem">Prerequisites</h2>
<!-- /wp:heading -->
<!-- wp:list -->
<ul style="list-style:none;padding:0;margin:0 0 2rem 0;display:flex;flex-direction:column;gap:0.5rem;font-size:0.9375rem;line-height:1.75;color:color-mix(in srgb, var(--wp--preset--color--contrast) 80%, transparent)">
<li style="display:flex;align-items:center;gap:0.75rem">${check} Node.js 18 or later</li>
<li style="display:flex;align-items:center;gap:0.75rem">${check} A GitHub, GitLab, or Bitbucket account</li>
<li style="display:flex;align-items:center;gap:0.75rem">${check} An API key (available from your dashboard)</li>
</ul>
<!-- /wp:list -->

<!-- wp:heading {"level":2,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"700"},"spacing":{"margin":{"bottom":"1rem"}}}} -->
<h2 class="wp-block-heading" style="font-size:1.5rem;font-weight:700;margin-bottom:1rem">Quick Start</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p style="font-size:0.9375rem;line-height:1.75;color:color-mix(in srgb, var(--wp--preset--color--contrast) 80%, transparent);margin-bottom:1rem">Install the CLI and initialize your first project in under two minutes:</p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"margin":{"bottom":"2rem"}}}} -->
<div class="wp-block-group" style="border-radius:0.75rem;overflow:hidden;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 15%, transparent);margin-bottom:2rem">
<!-- wp:group -->
<div class="wp-block-group" style="padding:0.5rem 1rem;background-color:color-mix(in srgb, var(--wp--preset--color--contrast) 5%, transparent);border-bottom:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 10%, transparent);font-size:0.75rem;font-weight:600;color:color-mix(in srgb, var(--wp--preset--color--contrast) 50%, transparent)">Terminal</div>
<!-- /wp:group -->
<!-- wp:code -->
<pre class="wp-block-code" style="padding:1.25rem 1.5rem;margin:0;background-color:color-mix(in srgb, var(--wp--preset--color--contrast) 3%, transparent);font-size:0.875rem;line-height:1.75;overflow-x:auto"><code>npm install -g @saasflow/cli
saasflow init my-project
cd my-project
saasflow deploy</code></pre>
<!-- /wp:code -->
</div>
<!-- /wp:group -->

<!-- wp:paragraph -->
<p style="font-size:0.9375rem;line-height:1.75;color:color-mix(in srgb, var(--wp--preset--color--contrast) 80%, transparent)">That's it. Your project is now live. Head to your dashboard to configure environments, add team members, and set up monitoring.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
...
const saasContact: SkeletonPage = {
  title: "Contact",
  slug: "contact",
  content: `<!-- wp:group {"layout":{"type":"constrained","contentSize":"960px"},"style":{"spacing":{"padding":{"top":"6rem","bottom":"6rem"}}}} -->
<div class="wp-block-group" style="padding-top:6rem;padding-bottom:6rem">

<!-- wp:group {"layout":{"type":"constrained","contentSize":"600px"},"style":{"spacing":{"margin":{"bottom":"4rem"}}}} -->
<div class="wp-block-group" style="text-align:center;margin-bottom:4rem">
<!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"clamp(2rem, 4vw, 3rem)","fontWeight":"800"}}} -->
<h1 class="wp-block-heading has-text-align-center" style="font-size:clamp(2rem, 4vw, 3rem);font-weight:800;margin-bottom:1rem">Get in touch</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center" style="font-size:1.125rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent);line-height:1.625">Have a question about our product, pricing, or need technical support? We'd love to hear from you.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"2rem","right":"2rem","bottom":"2rem","left":"2rem"},"margin":{"bottom":"1.5rem"}}}} -->
<div class="wp-block-group" style="padding:2rem;border-radius:1rem;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 10%, transparent);background-color:color-mix(in srgb, var(--wp--preset--color--contrast) 3%, transparent);margin-bottom:1.5rem">
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1rem","fontWeight":"700"},"spacing":{"margin":{"bottom":"0.5rem"}}}} -->
<h3 class="wp-block-heading" style="font-size:1rem;font-weight:700;margin-bottom:0.5rem">Sales</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p style="font-size:0.875rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent);margin-bottom:0.5rem">Talk to our sales team about enterprise plans and custom solutions.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p style="font-size:0.875rem;color:var(--wp--preset--color--primary);font-weight:600">sales@example.com</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="padding:2rem;border-radius:1rem;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 10%, transparent);background-color:color-mix(in srgb, var(--wp--preset--color--contrast) 3%, transparent);margin-bottom:1.5rem">
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1rem","fontWeight":"700"},"spacing":{"margin":{"bottom":"0.5rem"}}}} -->
<h3 class="wp-block-heading" style="font-size:1rem;font-weight:700;margin-bottom:0.5rem">Support</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p style="font-size:0.875rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent);margin-bottom:0.5rem">Need help with your account or a technical issue? We respond within 24 hours.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p style="font-size:0.875rem;color:var(--wp--preset--color--primary);font-weight:600">support@example.com</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"2rem","right":"2rem","bottom":"2rem","left":"2rem"}}}} -->
<div class="wp-block-group" style="padding:2rem;border-radius:1rem;border:1px solid color-mix(in srgb, var(--wp--preset--color--contrast) 10%, transparent);background-color:color-mix(in srgb, var(--wp--preset--color--contrast) 3%, transparent)">
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1rem","fontWeight":"700"},"spacing":{"margin":{"bottom":"0.5rem"}}}} -->
<h3 class="wp-block-heading" style="font-size:1rem;font-weight:700;margin-bottom:0.5rem">Office</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p style="font-size:0.875rem;color:color-mix(in srgb, var(--wp--preset--color--contrast) 60%, transparent);margin:0">123 Innovation Drive<br>San Francisco, CA 94107</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
