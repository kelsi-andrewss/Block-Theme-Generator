...
export default function Home() {
  ...
  function handleSelectGalleryTheme(theme: PremadeTheme) {
    ...
    const parts = {
      "header.html": `<!-- wp:html -->\n<nav style="width:100%; border-bottom:1px solid rgba(255,255,255,0.05); background-color:rgba(9,9,11,0.7); backdrop-filter:blur(24px); z-index:50;">\n  <div style="max-width:80rem; margin:0 auto; padding:0 1.5rem;">\n    <div style="display:flex; align-items:center; justify-content:space-between; height:5rem;">\n      <!-- Logo -->\n      <a href="/" style="display:flex; align-items:center; gap:0.5rem; text-decoration:none;">\n        <div style="width:2rem; height:2rem; border-radius:0.5rem; background-color:var(--wp--preset--color--primary); display:flex; align-items:center; justify-content:center; color:#fff; font-weight:700; box-shadow:0 10px 15px -3px rgba(59, 130, 246, 0.2);">S</div>\n        <span style="font-size:1.25rem; font-weight:700; color:#fff; letter-spacing:-0.025em; font-family:sans-serif;">\n          SaaS<span style="color:var(--wp--preset--color--primary)">Flow</span>\n        </span>\n      </a>\n      <!-- Links -->\n      <div style="display:flex; align-items:center; gap:2rem;">\n        <a href="#features" style="font-size:0.875rem; font-weight:500; color:#a1a1aa; text-decoration:none; font-family:sans-serif;">Features</a>\n        <a href="#testimonials" style="font-size:0.875rem; font-weight:500; color:#a1a1aa; text-decoration:none; font-family:sans-serif;">Customers</a>\n        <a href="#pricing" style="font-size:0.875rem; font-weight:500; color:#a1a1aa; text-decoration:none; font-family:sans-serif;">Pricing</a>\n      </div>\n      <!-- Actions -->\n      <div style="display:flex; align-items:center; gap:1.5rem;">\n        <a href="#login" style="font-size:0.875rem; font-weight:500; color:#a1a1aa; text-decoration:none; font-family:sans-serif;">Log in</a>\n        <a href="#signup" style="font-size:0.875rem; font-weight:500; background-color:#fff; color:#18181b; padding:0.625rem 1.25rem; border-radius:9999px; text-decoration:none; font-family:sans-serif; box-shadow:0 4px 6px -1px rgba(0, 0, 0, 0.1);">Get Started</a>\n      </div>\n    </div>\n  </div>\n</nav>\n<!-- /wp:html -->`,
      "footer.html": `<!-- wp:html -->\n<footer style="border-top:1px solid rgba(255,255,255,0.05); background-color:#09090b; padding-top:4rem; padding-bottom:2rem; font-family:sans-serif;">\n  <div style="max-width:80rem; margin:0 auto; padding:0 1.5rem;">\n    <div style="display:flex; flex-wrap:wrap; gap:3rem; margin-bottom:3rem;">\n      <div style="flex: 2; min-width:250px;">\n        <a href="#" style="display:flex; align-items:center; gap:0.5rem; margin-bottom:1rem; text-decoration:none;">\n          <div style="width:1.5rem; height:1.5rem; border-radius:0.375rem; background-color:var(--wp--preset--color--primary); display:flex; align-items:center; justify-content:center; color:#fff; font-size:0.75rem; font-weight:700;">S</div>\n          <span style="font-size:1.125rem; font-weight:700; color:#fff; letter-spacing:-0.025em;">SaaSFlow</span>\n        </a>\n        <p style="font-size:0.875rem; color:#a1a1aa; max-width:20rem; line-height:1.6; margin:0;">\n          Building the next generation of powerful, scalable SaaS tools for modern teams.\n        </p>\n      </div>\n      <div style="flex: 1; min-width:120px;">\n        <h3 style="font-weight:600; color:#fff; margin-bottom:1.5rem; font-size:0.875rem; line-height:1.2; margin-top:0;">Product</h3>\n        <div style="display:flex; flex-direction:column; gap:0.75rem;">\n          <a href="#" style="font-size:0.875rem; color:#a1a1aa; text-decoration:none;">Features</a>\n          <a href="#" style="font-size:0.875rem; color:#a1a1aa; text-decoration:none;">Integrations</a>\n          <a href="#" style="font-size:0.875rem; color:#a1a1aa; text-decoration:none;">Pricing</a>\n          <a href="#" style="font-size:0.875rem; color:#a1a1aa; text-decoration:none;">Changelog</a>\n        </div>\n      </div>\n      <div style="flex: 1; min-width:120px;">\n        <h3 style="font-weight:600; color:#fff; margin-bottom:1.5rem; font-size:0.875rem; line-height:1.2; margin-top:0;">Company</h3>\n        <div style="display:flex; flex-direction:column; gap:0.75rem;">\n          <a href="#" style="font-size:0.875rem; color:#a1a1aa; text-decoration:none;">About Us</a>\n          <a href="#" style="font-size:0.875rem; color:#a1a1aa; text-decoration:none;">Careers</a>\n          <a href="#" style="font-size:0.875rem; color:#a1a1aa; text-decoration:none;">Blog</a>\n          <a href="#" style="font-size:0.875rem; color:#a1a1aa; text-decoration:none;">Contact</a>\n        </div>\n      </div>\n      <div style="flex: 1; min-width:120px;">\n        <h3 style="font-weight:600; color:#fff; margin-bottom:1.5rem; font-size:0.875rem; line-height:1.2; margin-top:0;">Legal</h3>\n        <div style="display:flex; flex-direction:column; gap:0.75rem;">\n          <a href="#" style="font-size:0.875rem; color:#a1a1aa; text-decoration:none;">Privacy Policy</a>\n          <a href="#" style="font-size:0.875rem; color:#a1a1aa; text-decoration:none;">Terms of Service</a>\n        </div>\n      </div>\n    </div>\n    <div style="border-top:1px solid rgba(255,255,255,0.05); padding-top:2rem; display:flex; flex-wrap:wrap; justify-content:space-between; align-items:center; gap:1rem;">\n      <p style="font-size:0.875rem; color:#a1a1aa; margin:0;">\n        © 2026 SaaSFlow Inc. All rights reserved.\n      </p>\n      <div style="display:flex; gap:1rem;">\n        <a href="#" style="color:#a1a1aa;"><svg style="width:1.25rem; height:1.25rem;" fill="currentColor" viewBox="0 0 24 24"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"/></svg></a>\n        <a href="#" style="color:#a1a1aa;"><svg style="width:1.25rem; height:1.25rem;" fill="currentColor" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clip-rule="evenodd" /></svg></a>\n      </div>\n    </div>\n  </div>\n</footer>\n<!-- /wp:html -->`
    };
