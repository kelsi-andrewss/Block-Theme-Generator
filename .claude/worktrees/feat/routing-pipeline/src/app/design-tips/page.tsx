...
export default function DesignTipsPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 font-sans selection:bg-blue-500/30">
      <nav className="shrink-0 w-full z-30 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md border-b border-zinc-200/50 dark:border-zinc-800/50 px-6 py-4 flex items-center justify-between shadow-sm sticky top-0 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 flex gap-12 relative">
        ...
        <aside className="hidden lg:block w-64 shrink-0 h-[calc(100vh-73px)] sticky top-[73px] py-16">
          <div className="flex flex-col gap-1">
            <p className="text-[10px] font-black uppercase text-zinc-400 tracking-widest mb-4 px-4">Navigation</p>
            {navItems.map((item) => (
              <a
                key={item.id}
                href={`#${item.id}`}
        ...
        {/* Main Content */}
        <main className="flex-1 py-16 min-w-0 font-sans">
          ...
          <div className="space-y-32">
            ...
            <section id="precision" className="scroll-mt-32">
              ...
              <div className="grid md:grid-cols-2 gap-px bg-zinc-200 dark:bg-zinc-800 rounded-[2.5rem] overflow-hidden border border-zinc-200 dark:border-zinc-800 shadow-xl">
                ...
                <div className="bg-zinc-50 dark:bg-zinc-950 p-8 border-t border-zinc-200 dark:border-zinc-800">
                  ...
                  <p className="mt-2 text-xs text-zinc-400 italic font-sans font-sans">Shadow on what? The headline? The whole page?</p>
                </div>
                <div className="bg-white dark:bg-zinc-900 p-8 border-t border-l border-zinc-200 dark:border-zinc-800">
                  ...
                  <p className="mt-2 text-xs text-zinc-500 italic font-sans font-sans">Tells the AI exactly which objects to lift up.</p>
                </div>
                ...
                <div className="bg-white dark:bg-zinc-900 p-8 border-t border-l border-zinc-200 dark:border-zinc-800">
                  ...
                  <p className="mt-2 text-xs text-zinc-500 italic font-sans font-sans">Keeps the small text readable while fixing the look.</p>
                </div>
              </div>
            </section>
              ...
              <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="flex flex-col">
                  <div className="bg-zinc-100 dark:bg-zinc-800 rounded-3xl p-4 mb-4 h-48 flex gap-2 justify-center items-center border border-zinc-200 dark:border-zinc-700 overflow-hidden relative">
                    ...
                    <div className="px-4 py-1.5 bg-emerald-100 dark:bg-blue-900/30 text-emerald-600 dark:text-emerald-400 rounded-full text-[10px] font-black uppercase tracking-wider">Live</div>
            ...
            <section id="global" className="scroll-mt-32 font-sans">
              <div className="flex items-center gap-3 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6 rounded-3xl">
                  <p className="text-[10px] font-black text-orange-600 dark:text-orange-400 uppercase tracking-widest mb-4 flex items-center gap-2">
            ...
            <section id="mobile" className="scroll-mt-32 font-sans">
              <div className="flex items-center gap-3 mb-8">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <p className="font-bold text-zinc-900 dark:text-white flex items-center gap-2 text-sm">
                          <svg className="w-4 h-4 text-cyan-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
                          Fixing Columns
                      </p>
                    ...
                    <div className="space-y-3">
                      <p className="font-bold text-zinc-900 dark:text-white flex items-center gap-2 text-sm">
                          <svg className="w-4 h-4 text-cyan-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2z" /></svg>
                          Adjusting Size
                      </p>
            ...
            <section id="tone" className="scroll-mt-32 font-sans">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl font-bold text-zinc-900 dark:text-white font-sans font-sans">Change the "Voice"</h2>
              </div>
              <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-10 leading-relaxed font-sans font-sans font-sans">
            ...
            <section className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[3rem] p-12 text-white shadow-2xl shadow-blue-500/30 relative overflow-hidden font-sans">
              ...
              <div className="relative z-10">
                <h2 className="text-4xl font-black mb-6 flex items-center gap-4">
                  <svg className="w-10 h-10 text-blue-200 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="leading-none">Still stuck?</span>
                </h2>
                <p className="text-2xl text-blue-50 mb-10 leading-relaxed max-w-2xl font-sans font-medium">
                  If the AI makes a mess, hit <span className="font-bold text-white underline decoration-white/30 underline-offset-4">Undo</span>. It's much easier for the AI to get <span className="font-bold text-white underline decoration-white/30 underline-offset-4">one small change</span> right than three giant ones at once.
                </p>
          ...
          <footer className="mt-40 pt-10 border-t border-zinc-200 dark:border-zinc-800 text-center text-zinc-500 dark:text-zinc-500 text-sm font-sans font-sans">
